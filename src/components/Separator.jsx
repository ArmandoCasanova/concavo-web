  ...
  return (
    <div className="relative w-full h-24 md:h-28 flex items-center justify-center overflow-hidden border-y border-black/5">
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-4xl">
        <h2 className="text-3xl sm:text-4xl md:text-4xl font-display font-black tracking-widest text-white uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] select-none">
          {message}
        </h2>
      </div>
    </div>
